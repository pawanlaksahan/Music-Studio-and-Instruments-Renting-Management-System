...
async function testEmail() {
    try {
        ...
        // Using the from email as the destination for testing
        const targetEmail = process.env.AWS_SES_FROM_EMAIL || 'test@example.com';
        console.log(`Sending test email to: ${targetEmail}`);
        
        await sendEmail(targetEmail, 'Test Subject from Studio Management', 'This is a test email to verify AWS SES configuration.');
